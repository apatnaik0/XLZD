#!/usr/bin/env python3
"""Convert equal-volume shell-theta CSV/parquet files into HDF5 for the generic CNP pipeline."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Convert equal-volume shell-theta CSV/parquet files to HDF5")
    parser.add_argument(
        "--dataset-root",
        type=Path,
        default=repo_root / "outputs_equal_volume_shell_theta",
...
def main() -> None:
    ...
    print("=" * 72)
    print("CSV/PARQUET -> HDF5 conversion (XLZD equal-volume shell theta)")
